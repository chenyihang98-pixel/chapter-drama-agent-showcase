...
<p align="center">
  <a href="assets/demo/fable-48s.zh.mp4">
    <img src="assets/images/demo-poster.jpg" width="280" alt="《狼来了》演示成片画面：放羊的孩子坐在草地上大喊“狼来了！”">
  </a>
</p>

<p align="center">
  <a href="assets/demo/fable-48s.zh.mp4"><b>▶ 观看演示</b></a>
  &nbsp;·&nbsp;
  <a href="https://github.com/chenyihang98-pixel/chapter-drama-agent-showcase/raw/main/assets/demo/fable-48s.zh.mp4">下载视频（MP4，约 14 MB）</a>
  &nbsp;·&nbsp;
...
| 用途 | 服务方 | 演示所用模型 | 在流程中的作用 |
|---|---|---|---|
| 剧情与分镜 | 月之暗面 · Kimi | Kimi K3 | 原文理解、人物分析、剧情方案、台词与镜头设计，以及文字层面的检查 |
| 画面检查 | 阿里云 · 通义千问 | Qwen3.8-Max | 对照人物设定与镜头要求，逐项检查关键帧 |
| 人物与关键帧 | 火山引擎 · 火山方舟 | Seedream 5.0 Pro | 生成人物形象图和各镜头关键帧 |
| 镜头视频 | 火山引擎 · 火山方舟 | Seedance 2.5 | 以选用的关键帧为首帧，生成每个镜头的视频片段 |
| 角色对白与旁白 | 火山引擎 · 豆包语音 | Seed TTS 2.0 | 按角色声线合成台词与旁白 |
| 合成、字幕与导出 | 本地 | FFmpeg 与应用代码 | 按配音时间轴拼接画面与声音，生成字幕并导出，不调用 AI 服务 |
